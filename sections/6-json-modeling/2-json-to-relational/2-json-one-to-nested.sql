...
create or replace table sales_rel3(
    id int, state string, zip string, date date, price float) as
select id, v:location:state_city, v:location:zip, v:sale_date, v:price
from sales_json;
